...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "jhipdemo@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "jhipdemo API";

        private String description = "jhipdemo API documentation";
    ...
    public static class Metrics {
        ...
        public static class Graphite {
            ...
            private String prefix = "jhipdemo";
